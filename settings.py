...
input_handler.InputHandler.set_keyboard_action(input_handler.KEY_d, "paddle2_right")
input_handler.InputHandler.set_keyboard_action(input_handler.KEY_a, "paddle2_left")
...
TEXTURES["canon_inv"] = pygame.transform.flip(TEXTURES["canon"], True, False)
